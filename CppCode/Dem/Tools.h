...
static v1d unitvec (int n) {v1d res (d,0) ; res[n]=1 ; return res ; } /// Construct & return a unit vector \parameter n Unit dimension
...
// Vector operation with floating point error correction
