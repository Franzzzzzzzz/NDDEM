...
function CannonPhysics() {
    ...
    function setGravityAngleDegrees (theta) {
        var theta_rad = theta/180.*Math.PI;
    	world.gravity.set( 9.81*Math.sin(theta_rad), -9.81*Math.cos(theta_rad), 0 );
    }
    ...
    function setMeshVelocity( mesh, velocity, index = 0 ) {
		...
		if ( mesh.isInstancedMesh ) {
			...
			var bodies = meshMap.get( mesh );
			bodies[ index ].velocity.copy( velocity );
	...
	return {
        ...
        setGravityAngleDegrees: setGravityAngleDegrees,
