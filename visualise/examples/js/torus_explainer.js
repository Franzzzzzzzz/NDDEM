...
var torus_geometry = new THREE.TorusGeometry(R, r, 2 * Math.pow(2, quality), Math.pow(2, quality));
...
var phi_geometry = new THREE.TorusGeometry(r + R - r / 6., r / 5., 2 * Math.pow(2, quality), Math.pow(2, quality));
...
var theta_geometry = new THREE.TorusGeometry(r, r / 10., 2 * Math.pow(2, quality), Math.pow(2, quality));
