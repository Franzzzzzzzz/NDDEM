...
function VRController(gamepad) {
  ...
  this.pollForChanges = function () {
    var verbosity = VRController.verbosity,
      controller = this,
      controllerInfo =
        "> #" +
    ...
    if (
      ...
      if (gamepad.pose.orientation !== null || gamepad.pose.position !== null) {
        if (this.controllers[i] === undefined)
          VRController.onGamepadConnect(gamepad);
      ...
      //  the API’s intended behavior but it’s what I see in practice.
        ...
        VRController.onGamepadDisconnect(gamepad);
    }
  }
};
