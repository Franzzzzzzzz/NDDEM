...
THREE.NRRDLoader.prototype = {
	...
	parse: function ( data ) {
		...
		} else if ( headerObject.encoding === 'ascii' || headerObject.encoding === 'text' || headerObject.encoding === 'txt' || headerObject.encoding === 'hex' || headerObject.encoding === 'ASCII' || headerObject.encoding === 'ASCI') {
