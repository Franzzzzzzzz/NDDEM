...
function add_torus(scene,params,world,particles) {
    if (params.display_type == "VR") { R = 0.1; }
    else { R = 0.5; }
    r = R/2.;
    ...
    var geometry = new THREE.TorusBufferGeometry( R, r, Math.pow(2,params.quality+1)*2, Math.pow(2,params.quality+1) );
    ...
    var geometry = new THREE.TorusBufferGeometry( r+R-r/6., r/5., Math.pow(2,params.quality+1)*2, Math.pow(2,params.quality+1) );
    var material = new THREE.MeshPhongMaterial( {
    ...
    var geometry = new THREE.TorusBufferGeometry( r, r/10., Math.pow(2,params.quality+1)*2, Math.pow(2,params.quality+1) );
    ...
    if ( params.N > 5 ) {
        var geometry = new THREE.TorusBufferGeometry( R, r, Math.pow(2,params.quality)*2, Math.pow(2,params.quality) );
        var material = new THREE.MeshPhongMaterial( {
            color: 0xaaaaaa,
            // roughness: 0.7,
            // metalness: 0.5
        ...
        var geometry = new THREE.TorusBufferGeometry( r+R-r/6., r/5., Math.pow(2,params.quality)*2, Math.pow(2,params.quality) );
        var material = new THREE.MeshPhongMaterial( {
            color: 0x000000,
            // roughness: 0.7,
        } );
        ...
        var geometry = new THREE.TorusBufferGeometry( r, r/10., Math.pow(2,params.quality)*2, Math.pow(2,params.quality) );
...
function add_left_oculus_model(controller) {
    ...
    .load( 'oculus-touch-controller-left.mtl', function ( materials ) {
        ...
        .load( 'oculus-touch-controller-left.obj', function ( object ) {
            ...
            font_loader.load( params.root_dir + 'visualise/node_modules/three/examples/fonts/helvetiker_bold.typeface.json', function ( font ) {
                var fontsize = 0.005;
                ...
                if ( !params.no_tori ) {
                    ...
                    if ( params.N > 3 ) { object.add(move_label); }
        ...
        .load( 'oculus-touch-controller-right.obj', function ( object ) {
            ...
            font_loader.load( params.root_dir + 'visualise/node_modules/three/examples/fonts/helvetiker_bold.typeface.json', function ( font ) {
                ...
                if ( !params.no_tori ) {
                    ...
                    move_label.position.z = 0.045;
                    if ( params.N > 5 ) { object.add(move_label); }
                    // object.add(move_label);
                }
            });
        });
	...
	loader.load( 'vr_controller_vive_1_5.obj', function ( object ) {
        ...
        font_loader.load( params.root_dir + 'visualise/node_modules/three/examples/fonts/helvetiker_bold.typeface.json', function ( font ) {
            ...
            if ( !params.no_tori ) {
                ...
                move_label.position.z = 0.045;
                if ( params.N > 3 ) { controller1.add(move_label); }
                if ( params.N > 5 ) { controller2.add(move_label); }
                }
            });
      });
}
