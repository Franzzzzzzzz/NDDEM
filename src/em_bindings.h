...
EMSCRIPTEN_BINDINGS(DEMCG3D) {
  class_<DEMCG3D>("DEMCG3D")
    ...
    .function("simu_getParticleForce", &DEMCG3D::simu_getParticleForce)
...
EMSCRIPTEN_BINDINGS(DEMCG4D) {
  class_<DEMCG4D>("DEMCG4D")
    ...
    .function("simu_getParticleForce", &DEMCG4D::simu_getParticleForce)
...
EMSCRIPTEN_BINDINGS(DEMCG5D) {
  class_<DEMCG5D>("DEMCG5D")
    ...
    .function("simu_getParticleForce", &DEMCG5D::simu_getParticleForce)
